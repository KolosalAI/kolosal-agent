...
FunctionResult RetrievalFunction::execute(const AgentData& params) {
    ...
    try {
        ...
        auto& documentServiceManager = DocumentServiceManager::getInstance();
        
        // Check if document service is available
        if (!documentServiceManager.isAvailable()) {
        ...
        auto& documentService = documentServiceManager.getDocumentService();
...
FunctionResult GetEmbeddingFunction::execute(const AgentData& params) {
    ...
    try {
        ...
        try {
            documentServicePtr = &docServiceManager.getDocumentService();
...
FunctionResult TestDocumentServiceFunction::execute(const AgentData& params) {
    ...
    try {
        ...
        // Check if document service is available
        try {
            auto& documentService = docServiceManager.getDocumentService();

/**
 * @file agent_planning_system.hpp
...
#ifndef KOLOSAL_AGENT_INCLUDE_AGENT_PLANNING_SYSTEM_HPP_INCLUDED
#define KOLOSAL_AGENT_INCLUDE_AGENT_PLANNING_SYSTEM_HPP_INCLUDED
...
public:
    ...
    ExecutionPlan decompose_goal(const std::string& goal, 
                                ...
                                const PlanningStrategy strategy = PlanningStrategy::DEPENDENCY_AWARE);
    // Plan management
...
public:
    ...
    // Component access
    PlanningSystem* get__planning_system() { return planning_system.get(); }
    ReasoningSystem* get__reasoning_system() { return reasoning_system.get(); }
};

} // namespace kolosal::agents

#endif // KOLOSAL_AGENT_INCLUDE_AGENT_PLANNING_SYSTEM_HPP_INCLUDED
